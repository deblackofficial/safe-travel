...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (move_uploaded_file($permitTempName, $permitFolder)) {
        $_SESSION['form_data']['permit'] = $permitFileName;
...
<head>
  ...
  <title>Driver Report | Transport System</title>
        ...
        <form id="driverForm" method="POST" enctype="multipart/form-data" action="driver.php">
          ...
          <div class="form-group">
            ...
            <input type="text" id="plate" name="plate" class="form-control" 
                   placeholder="Enter plate number (e.g., RAF 123)" 
          ...
          <div class="form-group">
            <label class="form-label">Upload Your Permit</label>
            <div class="file-upload">
              <div class="file-upload-btn">
                <i class="fas fa-cloud-upload-alt" style="font-size: 24px; margin-bottom: 10px;"></i>
                <p>Click to upload permit (Image or PDF)</p>
                <input type="file" id="permit" name="permit" class="file-upload-input" accept="image/*,.pdf" required>
              </div>
            </div>
          </div>
