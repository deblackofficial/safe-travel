...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (move_uploaded_file($permitTempName, $permitFolder)) {
        $_SESSION['form_data']['upload'] = $permitFileName; // Save permit file name in session

        // Redirect to another page (if needed)
        header("Location: passengerfp.php"); // Replace with the next page if applicable
        exit();
    } else {
...
<body>
  <div class="container">
    <form id="passengerForm" method="POST" enctype="multipart/form-data" action="passenger.php">
      ...
      <input id="ticket" name="ticket" type="tel" placeholder="Eg: 1234 567 890" 
      ...
      <label for="permit">Upload <strong>file</strong> here</label>
      <input id="permit" name="upload" type="file" accept="image/*,.pdf" required />
