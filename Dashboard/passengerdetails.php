...
<head>
  ...
  <title>Passenger Reports | Transport System</title>
  ...
  <div class="dashboard-layout">
    <div class="sidebar">
      ...
      <nav>
        ...
        <a href="passengerdetails.php" class="active"><i class="fas fa-user-tag"></i> Passenger Reports</a>
      </nav>
    ...
    <div class="main-content">
      ...
      <div class="card">
        <div class="card-header">
          <h2 class="card-title">Passenger Report Details</h2>
        ...
        <form method="GET" class="filter-controls">
          ...
          <input type="text" class="search-input" name="search" 
                 placeholder="Search by ticket, agency, or plate number" 
              ...
              <tbody>
                ...
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                  <tr>
                    ...
                    <td>
                      <span class="badge badge-<?php echo $row['overloading'] ? 'yes' : 'no'; ?>">
                        <?php echo $row['overloading'] ? 'Yes' : 'No'; ?>
                      </span>
                    </td>
                    <td>
                    ...
                    <td>
                      <?php if (!empty($row['upload'])): ?>
                        <a href="../uploads/<?php echo htmlspecialchars($row['upload']); ?>" 
                           target="_blank" 
                    ...
                    <td>
                      <?php if (!$isArchived): ?>
                        <a href="archivepassenger.php?id=<?php echo $row['id']; ?>" 
        ...
        <?php else: ?>
          <div class="no-data">
            ...
            <p>No passenger reports found matching your criteria</p>
          </div>
        <?php endif; ?>
      </div>
    </div>
