...
<body>
  <div class="container">
    <h1>Driver Reports Details</h1>

    <div class="actions">
      <form method="GET" style="display: flex; gap: 10px;">
        <input type="text" name="search" placeholder="Search by Phone, Agency, or Plate" value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
          ...
          <tbody>
            ...
            <?php while ($row = mysqli_fetch_assoc($result)): ?>
              <tr>
                ...
                <td>
                  <?php if (!$isArchived): ?>
                    <a href="archivedriver.php?id=<?php echo $row['id']; ?>" class="icon icon-archive" onclick="return confirm('Are you sure you want to archive this record?');">🗑</a>
                  <?php endif; ?>
                </td>
              </tr>
            <?php endwhile; ?>
    ...
    <?php else: ?>
      <p class="no-data">No driver reports found.</p>
    <?php endif; ?>
  </div>
